...
function Hero() {
  ...
  <p className="text-sm md:text-lg mb-8 max-w-2xl">
    Experience premium automotive care with our comprehensive detailing services, ceramic coatings, and bespoke styling solutions
  </p>
  ...
  <Link href="/contact">
    <button className="relative w-[150px] md:w-[200px] px-6 py-3 md:px-8 md:py-4 
      ...
      [border-image:linear-gradient(90deg,#85A5F5,#1877F2,#4AF9F9)_1]
      text-center">
      Contact Us
    </button>
  </Link>
